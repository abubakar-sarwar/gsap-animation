...
const FaqsAccordian = ({ data, openId, setOpenId }: any) => {
  ...
  return (
    <div
      ...
      className="relative select-none grid grid-cols-2 gap-10 py-20 border-b-2 cursor-pointer border-white group"
    >
      ...
      {openId !== data?._id && (
        <div className="absolute top-1/2 right-5 -translate-y-1/2 faq_question">
